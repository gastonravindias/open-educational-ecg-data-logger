/*
  Educational ECG Data Logger
  Reference firmware release v1.1.0
  ...
  Waveform exercises use an ECG simulator; ADC-characterisation may use a calibrated low-voltage source.
*/
...
void setup() {
  ...
  if (oledReady) {
    ...
    display.setTextColor(SSD1306_WHITE);
    display.setCursor(0, 0);
    display.println("ECG logger v1.1");
